## ----install-packages, echo=F, results='hide'---------------------------------
...
## ----setup, echo=F, results='markup', warning=F, message=F--------------------
